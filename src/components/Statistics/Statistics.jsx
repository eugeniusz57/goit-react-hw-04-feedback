...
export const Statistics = ({ good, neutral, bad, total, positivePercentage,}) =>
    (<SatatisticsList>
        ...
        <SatatisticsListItems>Positive feedback: {total ? Math.round(positivePercentage)+`%` : 0}</SatatisticsListItems>
    </SatatisticsList>);
...
Statistics.propTypes = {
    ...
    total: PropTypes.number.isRequired, positivePercentage: PropTypes.number.isRequired,}
